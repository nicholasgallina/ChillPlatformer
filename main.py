...
pygame.display.set_caption("Morbo's Quest for Berries")
...
def play():
    while True:
        ...
        PLAY_TEXT = get_font(45).render("define game-logic here", True, HIGHLIGHTED_COLOR)
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(100).render("MAIN MENU", True, NON_HIGHLIGHTED_COLOR)
